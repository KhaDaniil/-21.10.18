...
cout << "Введите 2 числа в виде дроби a/b" << endl;
rational a, b;
cin >> a >> b;
...
cout << "Их разность = " << raz << endl;
cout << "Их произведение = " << pr << endl;
cout << "Их частное = " << cha << endl;
if (a>b) cout << "Первое больше" << a << "<" << b << endl;
else if (a < b) cout << "Второе больше" << a << ">" << b << endl;
else if (a==b) cout << "Числа равны" << endl;
swap(a, b);
cout << "Пример пользовательской функции swap(меняет значение по кругу):Первое число =" << a << " Второое =" << b << endl;
cout <<"Пример пользовательской функции ss(Среднее арифметическое) = " << SS << endl;
